...
difference()
{
	  translate([0,0,0])hull()
	  {
			...
			translate([body_width/2,33+body_height+0.25,2.5-12])rotate([0,-90,90])mg90s(0,true);
			//empty
			translate([0,0,-0.5])hull()
	  {
			...
			translate([body_width/2,-1,10])rotate([-90,0,0])cylinder(r=10,h=20);
			translate([body_width/2 - 10, -1, -10])cube(20);
			//raspberry pi holes
			translate([7,10])
			{
							cylinder(r=1.1,h=30);
